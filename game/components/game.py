...
from game.utils.constants import BG, ICON, SCREEN_HEIGHT, SCREEN_WIDTH, TITLE, FPS, FONT_STYLE, DEFAULT_TYPE, SHOOT_SOUND, EXPLOSION_SOUND, BACKGROUND_MUSIC
...
from game.components.heart.heart import Heart
...
class Game:
    ...
    def run(self):
        self.heart.count = 3 #contador de vidas
        self.score.reset()
        self.player.reset()
    ...
    def draw(self):
        ...
        self.heart.draw(self.screen)#para dibujar en pantalla
